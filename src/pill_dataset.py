...
class PillTransform:
    ...
    def crop_to_bbox(self, img: Image.Image, bbox):
        x, y, w, h = bbox
        mx = int(w * self.cfg.bbox_margin)
        my = int(h * self.cfg.bbox_margin)
...
class PillDataset(Dataset):
    def __init__(self, csv_path, cfg: PillImageConfig, train=True):
    ...
    def __getitem__(self, idx):
        ...
        return {
            ...
            "bbox": torch.tensor(bbox if bbox else [0, 0, 0, 0], dtype=torch.float32),
        }
